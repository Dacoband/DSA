...
public class MyList {
    ...
    void addFirst(int a, String n,int p){
        Phone data = new Phone(a, n, p);
    ...
    void removeAllPhonesWithI() {
        Node p = head;
        while(p != null){
            if (p.info.name.startsWith("I")) {
                if (p.pre != null) {
                    p.pre.next = p.next;
                }
                if (p.next != null) {
    ...
    void addNodeBeforeTail(int id, String name, int price){
        Phone data = new Phone(id, name, price);
    ...
    void f5() throws Exception {
        ...
        addNodeBeforeTail(id, name, price);
        //------ End your code here-----------------------------------------------------------
        //------------------------------------------------------------------------------------
        ftraverseFW(f);
        ftraverseBW(f);
